...
plt.title("Distribusi Sentimen Komentar RUU TNI")
plt.xlabel("Sentimen")
...
plt.title("Jumlah Komentar per Hari RUU TNI")
plt.xlabel("Tanggal")
plt.ylabel("Jumlah")
plt.tight_layout()
...
plt.title("Komentar RUU TNI Berdasarkan Platform")
plt.xlabel("Platform")
plt.ylabel("Jumlah")
plt.tight_layout()
...
for label in df['sentiment'].unique():
    ...
    plt.axis('off')
    plt.title(f"Wordcloud Sentimen {label.capitalize()} - RUU TNI")
    plt.tight_layout()
